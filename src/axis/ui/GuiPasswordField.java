...
public final class GuiPasswordField extends Gui {
   ...
   public void drawTextBox1() {
	      if(this.func_146176_q()) {
	         if(this.func_146181_i()) {
	            drawRect(this.field_146209_f - 1, this.field_146210_g - 10 - 1, this.field_146209_f + this.field_146218_h + 1, this.field_146210_g - 10 + this.field_146219_i + 1, -6250336);
	            drawRect(this.field_146209_f, this.field_146210_g - 10, this.field_146209_f + this.field_146218_h, this.field_146210_g - 10 + this.field_146219_i, -16777216);
	         }
   ...
   private void func_146188_c(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_) {
      ...
      var2.pos((double)p_146188_1_, (double)p_146188_4_, 0.0D).color(255, 255, 255, 255).endVertex();
      var2.pos((double)p_146188_3_, (double)p_146188_4_, 0.0D).color(255, 255, 255, 255).endVertex();
      var2.pos((double)p_146188_3_, (double)p_146188_2_, 0.0D).color(255, 255, 255, 255).endVertex();
      var2.pos((double)p_146188_1_, (double)p_146188_2_, 0.0D).color(255, 255, 255, 255).endVertex();
      var2.finishDrawing();
      GL11.glDisable(3058);
      GL11.glEnable(3553);
   }
