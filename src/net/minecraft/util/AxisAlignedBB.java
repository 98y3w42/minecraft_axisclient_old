...
public class AxisAlignedBB
{
    ...
    public AxisAlignedBB getThisBounds()
    {
      return newInstance(this.minX, this.minY, this.minZ, this.maxX, this.maxY, this.maxZ);
    }

    public static AxisAlignedBB newInstance(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, double paramDouble5, double paramDouble6)
    {
