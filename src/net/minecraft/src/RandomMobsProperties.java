...
public class RandomMobsProperties
{
    ...
    public RandomMobsProperties(String p_i68_1_, ResourceLocation[] p_i68_2_)
    {
        ConnectedParser connectedparser = new ConnectedParser("RandomMobs");
        this.name = connectedparser.parseName(p_i68_1_);
        this.basePath = connectedparser.parseBasePath(p_i68_1_);
        this.resourceLocations = p_i68_2_;
    }

    public RandomMobsProperties(Properties p_i69_1_, String p_i69_2_, ResourceLocation p_i69_3_)
    {
        ConnectedParser connectedparser = new ConnectedParser("RandomMobs");
        this.name = connectedparser.parseName(p_i69_2_);
        this.basePath = connectedparser.parseBasePath(p_i69_2_);
        this.rules = this.parseRules(p_i69_1_, p_i69_3_, connectedparser);
    }
