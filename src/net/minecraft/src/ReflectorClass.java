...
public class ReflectorClass
{
    ...
    public ReflectorClass(String p_i72_1_)
    {
        this(p_i72_1_, false);
    }

    public ReflectorClass(String p_i73_1_, boolean p_i73_2_)
    {
        this.targetClassName = null;
        this.checked = false;
        this.targetClass = null;
        this.targetClassName = p_i73_1_;
    ...
    public ReflectorClass(Class p_i74_1_)
    {
        this.targetClassName = null;
        this.checked = false;
        this.targetClass = null;
        this.targetClass = p_i74_1_;
        this.targetClassName = p_i74_1_.getName();
        this.checked = true;
    }
