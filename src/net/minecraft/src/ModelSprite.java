...
public class ModelSprite
{
    ...
    public ModelSprite(ModelRenderer p_i58_1_, int p_i58_2_, int p_i58_3_, float p_i58_4_, float p_i58_5_, float p_i58_6_, int p_i58_7_, int p_i58_8_, int p_i58_9_, float p_i58_10_)
    {
        this.modelRenderer = p_i58_1_;
        this.textureOffsetX = p_i58_2_;
        this.textureOffsetY = p_i58_3_;
        this.posX = p_i58_4_;
        this.posY = p_i58_5_;
        this.posZ = p_i58_6_;
        this.sizeX = p_i58_7_;
        this.sizeY = p_i58_8_;
        this.sizeZ = p_i58_9_;
        this.sizeAdd = p_i58_10_;
        this.minU = (float)p_i58_2_ / p_i58_1_.textureWidth;
        this.minV = (float)p_i58_3_ / p_i58_1_.textureHeight;
        this.maxU = (float)(p_i58_2_ + p_i58_7_) / p_i58_1_.textureWidth;
        this.maxV = (float)(p_i58_3_ + p_i58_8_) / p_i58_1_.textureHeight;
    }
