...
public class WorldServerOF extends WorldServer
{
    ...
    public WorldServerOF(MinecraftServer p_i4_1_, ISaveHandler p_i4_2_, WorldInfo p_i4_3_, int p_i4_4_, Profiler p_i4_5_)
    {
        super(p_i4_1_, p_i4_2_, p_i4_3_, p_i4_4_, p_i4_5_);
        this.mcServer = p_i4_1_;
    }
