...
public class PlayerControllerMP {
	...
	public boolean onPlayerDestroyBlock(BlockPos pos, EnumFacing side) {
		BlockBreakingEvent event = new BlockBreakingEvent(BlockBreakingEvent.EnumBlock.DESTROY, pos, side);
		event.call();
	...
	public boolean clickBlock(BlockPos loc, EnumFacing face) {
		BlockBreakingEvent event = new BlockBreakingEvent(BlockBreakingEvent.EnumBlock.CLICK, loc, face);
		event.call();
	...
	public boolean onPlayerDamageBlock(BlockPos posBlock, EnumFacing directionFacing) {
		BlockBreakingEvent event = new BlockBreakingEvent(BlockBreakingEvent.EnumBlock.DAMAGE, posBlock, directionFacing);
		event.call();
		...
		if (this.blockHitDelay > 0) {
			...
			if (block.getMaterial() == Material.air) {
				...
				if (this.stepSoundTickCounter % 4.0F == 0.0F) {
					this.mc.getSoundHandler().playSound(new PositionedSoundRecord(new ResourceLocation(block.stepSound.getStepSound()), (block.stepSound.getVolume() + 1.0F) / 8.0F, block.stepSound.getFrequency() * 0.5F,
