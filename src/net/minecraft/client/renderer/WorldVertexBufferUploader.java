...
public class WorldVertexBufferUploader
{
        ...
        if (p_181679_1_.getVertexCount() > 0)
        {
            ...
            for (int j = 0; j < list.size(); ++j)
            {
                ...
                else
                {
                    ...
                    switch (WorldVertexBufferUploader.WorldVertexBufferUploader$1.field_178958_a[enumusage.ordinal()])
                    {
                        case 1:
            ...
            for (int k1 = list.size(); i1 < k1; ++i1)
            {
                ...
                if (flag1)
                {
                    Reflector.callVoid(enumusage1, Reflector.ForgeVertexFormatElementEnumUseage_postDraw, new Object[] {vertexformat, Integer.valueOf(i1), Integer.valueOf(i), bytebuffer});
                }
                else
                {
                    int j1 = vertexformatelement1.getIndex();

                    switch (WorldVertexBufferUploader.WorldVertexBufferUploader$1.field_178958_a[enumusage1.ordinal()])
                    {
                        case 1:
    ...
    {
        static final int[] field_178958_a = new int[EnumUsage.values().length];
