...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float partialTicks) {
		...
		if (this.recordPlayingUpFor > 0) {
			...
			if (k1 > 8) {
				...
				//Logger.logChat("Record");

				HUD.Comfortaa18.drawString(this.recordPlaying, -this.getFontRenderer().getStringWidth(this.recordPlaying) / 2, -4, i1 + (k1 << 24 & -16777216));
				GlStateManager.disableBlend();
		...
		if (this.field_175195_w > 0) {
			...
			if (l1 > 8) {
				...
				mc.fontutil.drawStringWithShadow(this.field_175201_x, (-this.getFontRenderer().getStringWidth(this.field_175201_x) / 2), -10, 16777215 | j2);
				//HUD.Comfortaa18.drawString(this.field_175201_x, (float) (-this.getFontRenderer().getStringWidth(this.field_175201_x) / 2), -10.0F, 16777215 | j2);
				...
				mc.fontutil.drawStringWithShadow(this.field_175200_y, (-this.getFontRenderer().getStringWidth(this.field_175200_y) / 2), 5, 16777215 | j2);
				//HUD.Comfortaa18.drawString(this.field_175200_y, (float) (-this.getFontRenderer().getStringWidth(this.field_175200_y) / 2), 5.0F, 16777215 | j2);
	...
	public void func_181551_a(ScaledResolution p_181551_1_) {
		...
		if (this.remainingHighlightTicks > 0 && this.highlightingItemStack != null) {
			...
			if (k > 0) {
				...
				GlStateManager.enableBlend();
				GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
				mc.fontutil2.drawStringWithShadow(s,  i, j, 16777215 + (k << 24));
				GlStateManager.disableBlend();
				GlStateManager.popMatrix();
			}
		}
	...
	private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
		...
		for (Score score1 : arraylist1) {
			...
			mc.fontRendererObj.drawString(s2, i1 - this.getFontRenderer().getStringWidth(s2), l, 553648127);
			...
			if (k == arraylist1.size()) {
				...
				mc.fontRendererObj.drawStringWithShadow(s3, j + i / 2 - this.getFontRenderer().getStringWidth(s3) / 2, l - this.getFontRenderer().FONT_HEIGHT, 553648127);
			}
		}
	}
