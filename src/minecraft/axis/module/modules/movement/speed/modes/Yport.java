...
public class Yport extends SpeedMode implements Mode {
	...
	public void onUpdate(UpdateEvent event) {
		if (event.state == Event.State.PRE) {
			...
			if (((!mc.gameSettings.keyBindSneak.pressed) && (mc.gameSettings.keyBindBack.pressed)) || (mc.gameSettings.keyBindForward.pressed) || (mc.gameSettings.keyBindLeft.pressed) || (mc.gameSettings.keyBindRight.isPressed()))
	        {
	          mc.thePlayer.motionY = -999.0D;
