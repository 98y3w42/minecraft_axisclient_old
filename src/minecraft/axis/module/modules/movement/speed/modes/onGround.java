...
public class onGround extends SpeedMode implements Mode {
	...
	public void onUpdate(UpdateEvent event) {
		if (event.state == Event.State.PRE) {
	        ...
	        {
	          if (mc.thePlayer.fallDistance > 3.994D) {
	            return;
	          }
	          if ((mc.thePlayer.isInWater()) || (mc.thePlayer.isOnLadder())) {
	            return;
	          }
	          mc.thePlayer.posY -= 0.3993000090122223D;
	        ...
	        if ((mc.thePlayer.onGround) && ((mc.thePlayer.moveForward != 0.0F) || (mc.thePlayer.moveStrafing != 0.0F)) && (!mc.thePlayer.isCollidedHorizontally))
	        {
	          ...
	          mc.thePlayer.motionX *= 1.590000033378601D;
	          mc.thePlayer.motionZ *= 1.590000033378601D;
