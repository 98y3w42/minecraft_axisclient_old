...
public class Camera
{
  ...
  public Camera(Entity entity)
  {
    ...
    else if ((entity instanceof EntityLivingBase))
    {
      ...
      setRotationYaw(living.rotationYawHead);
    }
  }
  ...
  public Camera(Entity entity, double offsetX, double offsetY, double offsetZ, double offsetRotationYaw, double offsetRotationPitch)
  {
    ...
    this.posY += offsetY;
    this.posZ += offsetZ;
    this.rotationYaw = ((float)(this.rotationYaw + offsetRotationYaw));
    this.rotationPitch = ((float)(this.rotationPitch + offsetRotationPitch));
  }
