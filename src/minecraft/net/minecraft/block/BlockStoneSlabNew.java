...
public abstract class BlockStoneSlabNew extends BlockSlab
{
    ...
    public static final PropertyEnum<BlockStoneSlabNew.EnumType> VARIANT = PropertyEnum.<BlockStoneSlabNew.EnumType>create("axis", BlockStoneSlabNew.EnumType.class);
