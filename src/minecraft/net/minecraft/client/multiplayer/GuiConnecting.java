		...
		(new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet()) {
			public void run() {
				...
				try {
					...
					NetworkManager var7 = GuiConnecting.this.networkManager;
					...
					if (MCLeaks.isAltActive()) {
						GuiConnecting.this.networkManager
								.sendPacket(new C00PacketLoginStart(new GameProfile(null, MCLeaks.getMCName())));
					} else {
						var7 = GuiConnecting.this.networkManager;
						GuiConnecting var8 = GuiConnecting.this;
						GuiConnecting.this.networkManager
								.sendPacket(new C00PacketLoginStart(GuiConnecting.mc.getSession().getProfile()));
					}
