...
public class TextureMap extends AbstractTexture implements ITickableTextureObject
{
    ...
    private void updateIconGrid(int p_updateIconGrid_1_, int p_updateIconGrid_2_)
    {
        ...
        if (this.iconGridSize > 0)
        {
            ...
            {
                double d0 = (double)Math.min(textureatlassprite.getMinU(), textureatlassprite.getMaxU());
                double d1 = (double)Math.min(textureatlassprite.getMinV(), textureatlassprite.getMaxV());
                double d2 = (double)Math.max(textureatlassprite.getMinU(), textureatlassprite.getMaxU());
                double d3 = (double)Math.max(textureatlassprite.getMinV(), textureatlassprite.getMaxV());
