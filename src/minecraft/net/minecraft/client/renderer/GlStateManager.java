...
{
	private static final FloatBuffer floatBuffer = BufferUtils.createFloatBuffer(4);
    ...
    public static enum TexGen
    {
        ...
        private TexGen(String p_i6_3_, int p_i6_4_)
        {
        }
    }
    ...
    public static void setColorBuffer(float red, float green, float blue, float alpha)
    {
      floatBuffer.put(0, red);
      floatBuffer.put(1, green);
      floatBuffer.put(2, blue);
      floatBuffer.put(3, alpha);
      texEnv(8960, 8705, floatBuffer);
    ...
    public static void texEnv(int a, int b, FloatBuffer buffer)
    {
      GL11.glTexEnv(a, b, buffer);
    }
    ...
    public static void texEnv(int a, int b, int c)
    {
      GL11.glTexEnvi(a, b, c);
    }

    public static void setColorBuffer(int color)
    {
    	...
    	floatBuffer.put(0, red);
        floatBuffer.put(2, green);
        floatBuffer.put(1, blue);
        floatBuffer.put(3, alpha);
      texEnv(8960, 8705, floatBuffer);
