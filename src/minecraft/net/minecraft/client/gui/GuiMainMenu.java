...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(5, this.width / 2 - 124, j + 72 + 12, 20, 20, I18n.format("L", new Object[0])));
	...
	private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
		...
		this.buttonList.add(new GuiButton(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, 136, 20, I18n.format("menu.multiplayer", new Object[0])));
		this.buttonList.add(new GuiButton(50, this.width / 2 + 40, p_73969_1_ + p_73969_2_ * 1, 60, 20, I18n.format("MCLeaks", new Object[0])));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		if (button.id == 50) {
			this.mc.displayGuiScreen(new GuiRedeemToken(false));
		}
	 ...
	 */
	public static final ResourceLocation background = new ResourceLocation("textures/axis/background.png");
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		 ...
		 * this.drawTexturedModalRect(j + 155, k + 0, 0, 45, 155, 44); } else {
