...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    {
        return (Matrix4f) (Reflector.ForgeHooksClient_getMatrix.exists() ? Reflector.call(Reflector.ForgeHooksClient_getMatrix, new Object[] {this}): new Matrix4f(this.getMatrix4d()));
    }
