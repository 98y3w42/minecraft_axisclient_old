...
public class RandomMobsRule
{
    ...
    public RandomMobsRule(ResourceLocation p_i70_1_, int[] p_i70_2_, int[] p_i70_3_, BiomeGenBase[] p_i70_4_, RangeListInt p_i70_5_)
    {
        this.baseResLoc = p_i70_1_;
        this.skins = p_i70_2_;
        this.weights = p_i70_3_;
        this.biomes = p_i70_4_;
        this.heights = p_i70_5_;
    }
