...
public class Mipmaps
{
    ...
    public Mipmaps(String p_i57_1_, int p_i57_2_, int p_i57_3_, int[] p_i57_4_, boolean p_i57_5_)
    {
        this.iconName = p_i57_1_;
        this.width = p_i57_2_;
        this.height = p_i57_3_;
        this.data = p_i57_4_;
        this.direct = p_i57_5_;
        this.mipmapDimensions = makeMipmapDimensions(p_i57_2_, p_i57_3_, p_i57_1_);
        this.mipmapDatas = generateMipMapData(p_i57_4_, p_i57_2_, p_i57_3_, this.mipmapDimensions);
