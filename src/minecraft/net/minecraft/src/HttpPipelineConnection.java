...
public class HttpPipelineConnection
{
    ...
    public HttpPipelineConnection(String p_i46_1_, int p_i46_2_)
    {
        this(p_i46_1_, p_i46_2_, Proxy.NO_PROXY);
    }

    public HttpPipelineConnection(String p_i47_1_, int p_i47_2_, Proxy p_i47_3_)
    {
        this.host = null;
        this.port = 0;
