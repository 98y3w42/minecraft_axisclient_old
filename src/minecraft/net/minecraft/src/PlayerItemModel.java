...
public class PlayerItemModel
{
    ...
    public PlayerItemModel(Dimension p_i64_1_, boolean p_i64_2_, PlayerItemRenderer[] p_i64_3_)
    {
        this.textureSize = p_i64_1_;
        this.usePlayerTexture = p_i64_2_;
        this.modelRenderers = p_i64_3_;
    }
